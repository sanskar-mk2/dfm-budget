...
async def get_budgets(
    ...
    try:
        ...
        budgets = budget_service.get_budgets_by_salesperson(user_salesperson.salesman_no)
        ...
        return {
            ...
            "user_info": {
                ...
                "salesperson_name": user_salesperson.name
            },
...
async def update_budget(
    ...
    try:
        budget_service = BudgetService(db)
        budget = budget_service.update_budget(budget_id, budget_data.dict(exclude_unset=True))
...
async def generate_budget_from_sales(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, 
            detail=f"Error generating budget from sales: {str(e)}"
        )
