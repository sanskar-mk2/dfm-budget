...
class BudgetService:
        ...
        return [
            {
                ...
                "total_sales": budget.quarter_1_sales
                + budget.quarter_2_sales
                + budget.quarter_3_sales
                + budget.quarter_4_sales,
            }
    ...
    def update_budget(
        self, budget_id: int, budget_data: Dict[str, Any]
    ) -> Optional[Budget]:
    ...
    def generate_budget_from_sales(
        self,
        salesperson_id: int,
